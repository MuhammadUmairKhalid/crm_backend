...
def submit_agent_form(request):
    ...
    if request.method == 'POST':
        ...
        initial_draft_date = request.POST.get('initial_draft_date')
        future_draft_date = request.POST.get('future_draft_date')
        email = request.POST.get('email')
        policy_number = request.POST.get('policy_number')
        submission_date = request.POST.get('submission_date')
        drivers_license = request.POST.get('drivers_license')
        underwritten_by = request.POST.get('underwritten_by')
        jornaya_lead_id = request.POST.get('jornaya_lead_id')
